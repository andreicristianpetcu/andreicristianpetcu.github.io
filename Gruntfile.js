...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
          ...
          default: {
            options: {
              data: {
                ...
                url: "andreicristianpetcu.github.io",
                email: "andreip@posteo.net",
                
                googleanalytics: "UA-XXXXX-X",
                
                
                github: "andreicristianpetcu",
                title: "Blog",
                description: "GNU/Linux, Security and Free Software",
                truncatefeed: 0,
                linenos: true
              },
              template: {
        ...
        concat: {
            dist: {
                src: [
                    'static/bower_components/bootswatch-superhero-wiredep/dist/bootstrap.css',
                    'static/bower_components/highlightjs/styles/rainbow.css',
                    'build/css/style.css'
                ],
                dest: 'build/css/output.cssoutput.css'
            }
        },
        cssmin: {
            dist: {
        ...
        sitemap: {
            dist: {
                ...
                homepage: 'andreicristianpetcu.github.io/'
            }
        },
        'gh-pages': {
            options: {
